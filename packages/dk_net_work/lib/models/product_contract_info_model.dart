...
//
//     final productContractInfoModel = productContractInfoModelFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'product_contract_info_model.freezed.dart';
part 'product_contract_info_model.g.dart';

ProductContractInfoModel productContractInfoModelFromJson(String str) => ProductContractInfoModel.fromJson(json.decode(str));

String productContractInfoModelToJson(ProductContractInfoModel data) => json.encode(data.toJson());

@freezed
class ProductContractInfoModel with _$ProductContractInfoModel {
    const factory ProductContractInfoModel({
        @JsonKey(name: "status")
        int? status,
        @JsonKey(name: "msg")
        String? msg,
        @JsonKey(name: "data")
        Data? data,
    }) = _ProductContractInfoModel;

    factory ProductContractInfoModel.fromJson(Map<String, dynamic> json) => _$ProductContractInfoModelFromJson(json);
}
